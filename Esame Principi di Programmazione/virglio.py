...
# canti_path = "C:/Users/lambe/Desktop/Esame Principi di Programmazione/canti" # in alternatica inverto i backslash
canti_path = r"C:\Users\lambe\Desktop\Esame Principi di Programmazione\canti"  # raw line
...
class Virgilio:
    ...
    def __init__(self, canti_path):
        self.directory = os.path.abspath(canti_path)  # trasformazione in un percorso assoluto
    ...
    def count_tercets(self, canto_number):
        ...
        if verses_number % 3 == 0:
            return int(verses_number/3)
        else:
            verses_number -= (verses_number % 3)
            return int(verses_number/3)
    ...
    def get_hell_verse_mean_len(self):
        ...
        avarage_lenght = hell_lenght / self.count_hell_verses()
        return avarage_lenght


cantore = Virgilio(canti_path)

""" Test Metodo 13/14/15/16/17"""
# print(f"{cantore.read_canto_lines(1, True, 3)}")
""" Test Metodo 12"""
# print(f"{cantore.get_hell_verse_mean_len()}")

""" Test Metodo 11"""
# print(f"{cantore.count_hell_verses()}")

""" Test Metodo 10"""
# print(f"{cantore.get_all_verses()}")

""" Metodo 9/18"""
# print(f"{cantore.count_words(1, ["mezzo", "MEzzo"])}")

""" Test Metodo 8"""
# print(f"{cantore.get_longest_canto()}")
""" Test Metodo 7"""
# print(f"{cantore.get_longest_verse(2)}") testing difficoltoso

""" test metodo 6 """
# print(f"{cantore.get_verses_with_word(5,"volte")}")
""" test metodo 5"""
# print(f"{cantore.get_verse_with_word(1,"mezzo")}")

# print(f"{cantore.count_word(1, "mezzo")}")
""" Test Metodi 1/2"""
# print(f"{cantore.count_verses(1)}")
# print(f"{cantore.read_canto_lines(1)}")
""" Test Metodo 3 """
# print(f"{cantore.count_verses(1)}")
# print(f"{cantore.count_tercets(19)}")
""" Test Metodo 3 """
# print(f"{cantore.count_verses(1)}")
# print(f"{cantore.count_tercets(1)}")
